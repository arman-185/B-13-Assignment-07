...
const TimeLines = () => {
    ...
    return (
        <div className='max-w-3xl mx-auto p-6'>
            ...
            {timelines.length === 0 && (
                <p className='text-gray-400 text-center mt-10'>No interactions yet. Use Quick Check-In to log one.</p>
            )}

            <div className='flex flex-col gap-3'>
                {timelines.map((item, ind) => (
                    <div key={ind} className='flex items-center justify-between border border-gray-200 rounded-xl px-5 py-4 bg-white hover:shadow-sm transition'>
